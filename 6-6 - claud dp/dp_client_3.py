...
# Load dataset
X_train, y_train = load_dataset("Data/Train/client_3.csv")
X_test, y_test = load_dataset("Data/Test/client_3_test.csv")
...
class DPLoanClient(fl.client.NumPyClient):
    """Differentially Private Client 3"""
...
if __name__ == "__main__":
    print("="*60)
    print("DP FEDERATED LEARNING CLIENT 3")
    print("="*60)
